        ...
        <div className="row row-cols-1 row-cols-md-2 align-items-md-center g-5">
              ...
              <div className="col d-flex align-items-start">
                ...
                <div>
                  ...
                  <p className="text-body-secondary">
                    <b>Reinforce Lab Ltd</b>,<br />
                    Suite #302, Level-3, Concord Tower, 113 Kazi Nazrul Islam
          ...
          <div className="col-md-12 mx-auto col-lg-6">
            <form className="p-3 p-md-5 border rounded-0 bg-body-tertiary">
              ...
              <div className="form-floating mb-3">
                <textarea
                  className="form-control inputtxtsiz"
                  value={text}
                  rows="10"
                  onChange={(ev) => setptext(ev.target.value)}
                >
                  {" "}
                </textarea>
